...
const StakeholderReport = () => {
    ...
    const handleExport = async () => {
        try {
            ...
            a.href = url;
            a.download = `Stakeholder_Summary_Report.xlsx`;
            a.click();
        } catch (error) {
    ...
    return (
        <div className="stakeholder-report-page minimal">
            <header className="report-header-minimal">
                <div className="header-top">
                    <h1 className="main-title">STAKEHOLDER REPORT</h1>
            ...
            <main className="report-main-content">
                <div className="table-header-row">
                    <h3 className="section-title">Stakeholder Summary Report</h3>
                ...
                <div className="modern-table-container">
                    <table className="aesthetic-table">
                        ...
                        <tbody>
                            {loading ? (
                                <tr><td colSpan="10" className="td-status-minimal">Fetching report data...</td></tr>
                                ...
                                <tr><td colSpan="10" className="td-status-minimal">No records display for current selection</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
